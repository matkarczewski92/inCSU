...
if (isset($_POST['text'])) {
    ...
    update('up_cities', 'id', $_GET['ptyp'], 'text', $text);
    update('up_cities', 'id', $_GET['ptyp'], 'webpage_url', $_POST['webpage_url']);

    $url_awatar = _URL . '/user_gfx/' . $file_name_sql;
    if ($file_name_sql != '') {
        update('up_cities', 'id', $_GET['ptyp'], 'arm_url', $url_awatar);
    }
    $url_awatar2 = _URL . '/user_gfx/' . $file_name_sql2;
    if ($file_name_sql2 != '') {
        update('up_cities', 'id', $_GET['ptyp'], 'gfx_url', $url_awatar2);
    }
