...
if (isset($_POST['id_user'])) {
    $id_ui = strtoupper($_POST['id_user']);
    $id_f_lider = substr($id_ui, 0, 1);

    $idz = explode("|", $_POST['id_user']);
    $to_id = $idz[1];
    ...
    if (substr($to_id, 0, 2) == 'U0' or $to_id == '') {
        ...
        if ($ui_info['name'] != '') {
            ...
            $id_to = $to_id;
            echo Create::WorkerOrg($to_id, $id ,$_POST['period'],$_POST['name'],$_POST['salary'],$_POST['until_date'],$law,$bank,$proposal,$edit,$workers,$org, $_POST['org_id']);
        } else {
  ...
  <input class="w3-input w3-border w3-light-grey" id="myInput1" type="text" style="width: 500px" name="id_user">   </div>
    ...
    <tr>
        <td width="20" align="center" valign="top"><span class="material-icons">gavel</span></td>
