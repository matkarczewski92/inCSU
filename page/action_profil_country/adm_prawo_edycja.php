...
if (isset($_POST['name'])) {
    ...
    <select name="id_cat_low" style="width: 500px">
...
if(isset($_POST['xcvb'])){
    ...
    if($law_info_s['name']!='' AND $law_info_s['state_id']==$id) {
        echo '<a href="'._URL.'/profil/adm_prawo_edycja/'.$id.'/'.$_POST['xcvb'].'" style="text-decoration: none; color: #1d4e85">'.$law_info_s['name'] . ' - kliknij by edytować</a>';
